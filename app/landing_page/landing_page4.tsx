    ...
    <main className="bg-[#F9F9F9] dark:bg-[#121212] text-[#212121] dark:text-white font-sans transition-colors duration-300">
      ...
      <section className="min-h-screen flex flex-col justify-center items-center text-center px-4 bg-[#FFF5EB] dark:bg-[#2B2B2B] relative overflow-hidden">
        <motion.img
          src="/grubz-logo.png"
          alt="Grubz Logo"
          className="w-24 h-24 mb-6 z-10"
          initial={{ opacity: 0, scale: 0.8 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.8, delay: 0.2 }}
        />
        <motion.h1
          className="text-5xl md:text-7xl font-extrabold text-[#FF6D00] mb-2 tracking-tight z-10"
        ...
        <div className="absolute -bottom-20 -left-20 w-[150%] h-96 bg-[#FF6D00]/10 rounded-full blur-3xl z-0"></div>
      </section>
